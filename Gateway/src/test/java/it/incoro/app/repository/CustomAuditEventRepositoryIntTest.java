...
import it.incoro.app.config.audit.AuditEventConverter;
import it.incoro.app.domain.PersistentAuditEvent;
...
import static it.incoro.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
