...
import { AsdfComponent } from 'app/entities/UserMJ/asdf/asdf.component';
import { AsdfService } from 'app/entities/UserMJ/asdf/asdf.service';
import { Asdf } from 'app/shared/model/UserMJ/asdf.model';

describe('Component Tests', () => {
    describe('Asdf Management Component', () => {
        let comp: AsdfComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AsdfComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.asdfs[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
