...
import { ActioneventComponent } from 'app/entities/ThingMJ/actionevent/actionevent.component';
...
describe('Component Tests', () => {
    describe('Actionevent Management Component', () => {
        let comp: ActioneventComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ActioneventComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.actionevents[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
