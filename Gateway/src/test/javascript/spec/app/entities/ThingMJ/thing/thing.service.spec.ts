...
describe('Service Tests', () => {
    describe('Thing Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ThingService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'thingmj/api/things';
                expect(req.request.url).toEqual(resourceUrl + '/' + '123');
            });

            it('should create a Thing', () => {
                service.create(new Thing(null)).subscribe(received => {
            ...
            it('should update a Thing', () => {
                service.update(new Thing('123')).subscribe(received => {
