...
export class ThingComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.thingService
            ...
            .subscribe(
                (res: HttpResponse<IThing[]>) => this.paginateThings(res.body, res.headers),
    ...
    trackId(index: number, item: IThing) {
        return item.id;
    }
    ...
    private paginateThings(data: IThing[], headers: HttpHeaders) {
