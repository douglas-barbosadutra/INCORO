  ...
  <div class="column menu" id="menu-destra">
	...
	<form action="/Thing/creaThing" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="xml" placeholder="Xml" required autofocus>				
					</div>
					<h4>Label: <select  id = "user" name ="idLabel" placeholder = "inserisci Label" required autofocus>
     		<%
     		out.println(1);
