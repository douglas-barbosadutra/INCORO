	...
	<div class="clearfix" id="corpo">
			...
			<ul style="list-style: none;">
				...
				<li>
					<form action="/User/reindirizzaCrea">
						<button class="btn btn-lg btn-primary btn-block" type="submit">Insert User</button>
					</form>
		...
		<div class="column content" id="visualizzazione">
			...
			<div class="col-md-8 themed-grid-col data-header">
				<div class="pb-3">
					<span><b class="tipo-dato">ID</b> 
					<span class="contenuto-dato"> <% out.println(users.get(i).getIdUser()); %></span>
 					</span>
				</div>
				<div class="row">
				...
				<p class="link-row">
					<a href="/User/delete?id=<%out.println(users.get(i).getIdUser());%>" class="btn btn-primary my-2 t-action"> Elimina</a> 
					<a href="/User/reindirizzaModifica?id=<%out.println(users.get(i).getIdUser());%>" class="btn btn-secondary my-2 t-action"> Modifica</a> 
